...
export class Header extends BaseComponent {
    ...
    private readonly HOME_BAR_BUTTON_LOCATOR = "//div[@class='navigation']//a[contains(string(),'Home')]";
    private readonly BROWSE_SETS_BAR_BUTTON_LOCATOR = "//div[@class='navigation']//a[contains(string(),'Browse Sets')]";
    private readonly SHOP_BAR_BUTTON_LOCATOR = "//div[@class='navigation']//a[contains(string(),'Shop')]";
    private readonly SIGN_IN_BUTTON_LOCATOR = "//div[@class='userinfo']//a[contains(string(),'sign in')]";
    private readonly REGISTER_BUTTON_LOCATOR = "//div[@class='userinfo']//a[contains(string(),'register')]";
    private readonly USERNAME_LOCATOR = "//div[@class='userinfo']//*[@class='username']";
